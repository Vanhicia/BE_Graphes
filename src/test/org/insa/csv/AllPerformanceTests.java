...
public class AllPerformanceTests {
	...
	public void testsPerformance() {
		...
		test1Temps.doRun("C:/Users/Utilisateur/Desktop/BE_Graphes/input/haute-garonne.txt", "resultat_performance_haute_garonne_temps.csv", 0);
		
		TestPerformance test1Distance = new TestPerformance();
		test1Distance.doRun("C:/Users/Utilisateur/Desktop/BE_Graphes/input/haute-garonne.txt", "resultat_performance_haute_garonne_distance.csv", 1);
